...
public class DownTrainIDRegister {
    ...
    public DownTrainIDRegister(int id, String trainnumber, String train, String trainOffDay, String realTime, String bbTime, String noticed) {
        this.id = id;

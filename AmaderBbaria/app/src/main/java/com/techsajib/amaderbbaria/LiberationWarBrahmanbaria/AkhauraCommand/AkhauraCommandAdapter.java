...
public class AkhauraCommandAdapter extends ArrayAdapter<AkhauraCommandIDRegister> {

    private ArrayList<AkhauraCommandIDRegister> data;
    private Context context;

    public AkhauraCommandAdapter(ArrayList<AkhauraCommandIDRegister> data, @NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        AkhauraCommandIDRegister datamodel = getItem(position);

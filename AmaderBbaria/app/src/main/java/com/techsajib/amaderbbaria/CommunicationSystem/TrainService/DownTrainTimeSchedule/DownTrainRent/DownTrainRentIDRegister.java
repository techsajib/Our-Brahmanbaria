...
public class DownTrainRentIDRegister {
    ...
    public DownTrainRentIDRegister(int id, String train, String aCSeat, String snigdaAC, String firstClass, String shovonChair, String shovon, String sulob, String notice) {
        this.id = id;
        this.train = train;
        this.aCSeat = aCSeat;

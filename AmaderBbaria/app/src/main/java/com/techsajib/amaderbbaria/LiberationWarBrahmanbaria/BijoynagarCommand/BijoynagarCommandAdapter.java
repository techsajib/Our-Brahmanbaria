...
public class BijoynagarCommandAdapter extends ArrayAdapter<BijoynagarCommandIDRegister> {

    private ArrayList<BijoynagarCommandIDRegister> data;
    private Context context;

    public BijoynagarCommandAdapter(ArrayList<BijoynagarCommandIDRegister> data, @NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        BijoynagarCommandIDRegister datamodel = getItem(position);

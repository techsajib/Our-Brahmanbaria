...
public class SadarAdapter extends ArrayAdapter<SadarIDRegister> {

    private ArrayList<SadarIDRegister> data;
    private Context context;

    public SadarAdapter(ArrayList<SadarIDRegister> data, @NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        SadarIDRegister datamodel = getItem(position);

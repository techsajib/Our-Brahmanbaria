...
public class BancharampurCommandAdapter extends ArrayAdapter<BancharampurCommandIDRegister> {

    private ArrayList<BancharampurCommandIDRegister> data;
    private Context context;

    public BancharampurCommandAdapter(ArrayList<BancharampurCommandIDRegister> data, @NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        BancharampurCommandIDRegister datamodel = getItem(position);

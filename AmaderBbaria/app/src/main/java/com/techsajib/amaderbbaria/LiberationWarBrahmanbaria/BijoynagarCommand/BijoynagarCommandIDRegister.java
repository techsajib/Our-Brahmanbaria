...
public class BijoynagarCommandIDRegister {
    ...
    public BijoynagarCommandIDRegister(int id, String designationNameText, String soldierNameText, String soldierFatherNameText, String soldierAddressText) {
        this.id = id;

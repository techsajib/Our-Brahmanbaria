...
public class NasirnagarCommandIDRegister {
    ...
    public NasirnagarCommandIDRegister(int id, String designationNameText, String soldierNameText, String soldierFatherNameText, String soldierAddressText) {
        this.id = id;

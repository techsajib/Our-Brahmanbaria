...
public class NabinagarCommandAdapter extends ArrayAdapter<NabinagarCommandIDRegister> {

    private ArrayList<NabinagarCommandIDRegister> data;
    private Context context;

    public NabinagarCommandAdapter(ArrayList<NabinagarCommandIDRegister> data, @NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        NabinagarCommandIDRegister datamodel = getItem(position);

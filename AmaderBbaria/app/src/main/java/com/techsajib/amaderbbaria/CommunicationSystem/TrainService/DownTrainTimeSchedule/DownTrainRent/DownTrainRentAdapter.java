...
import com.techsajib.amaderbbaria.CommunicationSystem.TrainService.UpTrainTimeSchedule.UpTrainRent.UpTrainRentAdapter;
...
public class DownTrainRentAdapter extends ArrayAdapter<DownTrainRentIDRegister> {

    private ArrayList<DownTrainRentIDRegister> data;
    private Context context;

    public DownTrainRentAdapter (ArrayList<DownTrainRentIDRegister> data, @NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        DownTrainRentIDRegister datamodel = getItem(position);

...
public class AshuganjCommandAdapter extends ArrayAdapter<AshuganjCommandIDRegister> {

    private ArrayList<AshuganjCommandIDRegister> data;
    private Context context;

    public AshuganjCommandAdapter(ArrayList<AshuganjCommandIDRegister> data, @NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        AshuganjCommandIDRegister datamodel = getItem(position);

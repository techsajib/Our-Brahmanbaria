...
public class AliaMadrasaAdapter extends ArrayAdapter<AliaMadrasaIDRegister> {

    private ArrayList<AliaMadrasaIDRegister> data;
    private Context context;

    public AliaMadrasaAdapter(ArrayList<AliaMadrasaIDRegister> data, @NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        AliaMadrasaIDRegister datamodel = getItem(position);

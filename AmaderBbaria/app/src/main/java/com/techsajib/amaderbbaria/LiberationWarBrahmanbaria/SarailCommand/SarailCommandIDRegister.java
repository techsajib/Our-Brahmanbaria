...
public class SarailCommandIDRegister {
    ...
    public SarailCommandIDRegister(int id, String designationNameText, String soldierNameText, String soldierFatherNameText, String soldierAddressText) {
        this.id = id;

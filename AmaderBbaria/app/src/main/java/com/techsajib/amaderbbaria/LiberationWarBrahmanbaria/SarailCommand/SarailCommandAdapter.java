...
public class SarailCommandAdapter extends ArrayAdapter<SarailCommandIDRegister> {

    private ArrayList<SarailCommandIDRegister> data;
    private Context context;

    public SarailCommandAdapter(ArrayList<SarailCommandIDRegister> data, @NonNull Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        SarailCommandIDRegister datamodel = getItem(position);
